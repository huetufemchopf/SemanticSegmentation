...
wget https://www.dropbox.com/s/iw5zt7jbtj5lkf6/model_bestbest.pth.tar?dl=1
...
#mkdir hw2_data
#nzip ./hw2_data.zip -d hw2_data

# Remove the downloaded zip file
#rm ./hw2_data.zip

mv model_bestbest.pth.tar?dl=1 ./log/model_bestbest.pth.tar
