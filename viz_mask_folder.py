...
if __name__ == '__main__':
    ...
    img_path_folder = args.img_path
    seg_path_folder = args.seg_path

    for i in os.listdir(seg_path_folder):

        img = scipy.misc.imread(img_path_folder + "/" + i)
        seg = scipy.misc.imread(seg_path_folder  + "/" + i)
        ...
        scipy.misc.imsave('./segmentations/' + i, img)
